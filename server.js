...
let movieUrl =`https://api.themoviedb.org/3/search/movie?query=${userMovieTitle}&api_key=87a32ef55335ba35e416797010a0e286`;
let genresUrl = "https://api.themoviedb.org/3/genre/movie/list?api_key=87a32ef55335ba35e416797010a0e286&language=en-US";
...
for(let i = 0; i < movieGenreIds.length; i++){
    ...
    let movieData = {
        ...
        year: new Date(movieRaw.release_date).getUTCFullYear(),
